...
def mundotecno(table_id, csv_path=None, webdriver_path=None):

    logging.getLogger().setLevel(logging.INFO)
    store_name = 'Mundo Tecno'

    categories = [
        {'url': 'https://www.mundotecno.com.uy/productos/productos.php?path=0.2498&secc=productos&ps=100&order=1&mo=1&pagina={}',
         'pages': [0, 1]},
        {'url': 'https://www.mundotecno.com.uy/productos/?path=0.2668&secc=productos&order={}&mo=1&ps=100',
         'pages': [1]},
        {'url': 'https://www.mundotecno.com.uy/productos/productos.php?path=0.2520&secc=productos&ps=100&order=1&mo={}',
         'pages': [1]},
        {'url': 'https://www.mundotecno.com.uy/productos/productos.php?path=0.2531&secc=productos&ps=100&order=1&mo=1&pagina={}',
         'pages': [0, 1]},
        {'url': 'https://www.mundotecno.com.uy/productos/productos.php?path=0.2558&secc=productos&ps=100&order=1&mo={}',
         'pages': [1]},
        {'url': 'https://www.mundotecno.com.uy/productos/productos.php?path=0.2565&secc=productos&ps=100&order=1&mo=1&pagina={}',
         'pages': [0, 1, 2, 3]},
        {'url': 'https://www.mundotecno.com.uy/productos/productos.php?path=0.2616&secc=productos&ps=100&order=1&mo={}',
         'pages': [1]},
        {'url': 'https://www.mundotecno.com.uy/productos/productos.php?path=0.2622&secc=productos&ps=100&order=1&mo={}',
         'pages': [1]},
        {'url': 'https://www.mundotecno.com.uy/productos/productos.php?path=0.2632&secc=productos&ps=100&order=1&mo={}',
         'pages': [1]},
    ]
        ...
        for page in category['pages']:
            ...
            for product in all_products:
                ...
                if product_price_lista is not None:
                    ...
                    price_currency = product.find('span', {'class': 'pmoneda'}).get_text().replace('USD', 'U$S')\
                                                                                          .replace('$U', '$')
                else:
                    ...
                    if product_price_lista is not None:
                        ...
                        price_currency = product.find('span', {'class': 'pmoneda'}).get_text()\
                                                                                   .replace('USD', 'U$S')\
                                                                                   .replace('$U', '$')
                    else:
